const messages = {
  pt: {
    translations: {
      ...
      chat: {
        noTicketMessage: "Selecione um atendimento para começar uma conversa.",
      },
      uploads: {
        titles: {
      ...
      transferTicketModal: {
        ...
        fieldLabel: "Digite para buscar atendentes",
      ...
      users: {
        ...
        confirmationModal: {
          deleteTitle: "Excluir",
          deleteMessage:
            "Todos os dados do atendente serão perdidos. Os atendimento abertos deste atendente serão movidos para o setor.",
        },
      },
      helps: {
